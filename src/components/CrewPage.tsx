    ...
    >
      ...
      <div className="grid content-start justify-items-center px-6 md:pt-6 lg:grid-cols-[minmax(2rem,2fr)_minmax(0,500px)_minmax(2rem,5rem)_minmax(0,500px)_minmax(2rem,2fr)] ">
        ...
        <img
          ...
          alt="moon image"
          className="mt-8 max-w-[60%] border-b border-b-white/30 md:w-[60%] md:max-w-[400px] lg:col-span-1 lg:col-start-2 lg:row-span-2 lg:w-auto  lg:max-w-full lg:self-center"
        />
        <div className="lg:col-span-1 lg:col-start-4 lg:justify-self-start">
          <ul className="mt-6 flex flex-row gap-6 font-sans-cond text-300 uppercase tracking-wide md:mt-10  lg:tracking-wider [&_li]:cursor-pointer ">
            <li className="rounded-full  bg-white p-[5px]"></li>
            <li className="rounded-full bg-white/40 p-[5px]"></li>
            <li className="rounded-full bg-white/40 p-[5px]"></li>
            <li className="rounded-full bg-white/40 p-[5px]"></li>
          </ul>
        </div>
        <div className="mt-6 text-center  lg:col-span-1 lg:col-start-4 lg:text-left">
          <p className="font-serif text-600 uppercase  text-white/50">
            Commander
          </p>
          <h1 className="mt-2 font-serif text-700 uppercase text-white md:mt-6">
            Douglas Hurley
          </h1>
          <p className="mt-4 max-w-[62ch] pb-8 text-center font-sans text-400 leading-6 text-light-blue md:leading-7 lg:text-left lg:leading-8 ">
